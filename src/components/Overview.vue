    ...
    >
            ...
            <div class="layout fill-height align-center justify-end">
              <div class="mx-2" style="width: 50%">
                <div class="layout fill-height align-center">
                  <div style="width: 150px; font-size: 0.8vw">
                    Compare Month
                  </div>
                  <input
                    type="date"
      ...
      <div style="height: calc(100% - 70px); background-color: #fff">
        <div class="layout fill-height pa-3">
          <div
            class="layout fill-height pa-3 elevation-2"
            style="border-radius: 10px"
          >
            <div
              class="layout overflow-y-hidden elevation-2 column"
              style="
                height: 100%;
                width: 50%;
            ...
            >
              <v-card>
                <v-tabs background-color="#f7f3f8" color="deep-purple accent-4">
                    ...
                    >
                      ...
                      <v-row>
                        <v-col sm="5" md="6">
                          ...
                          >
                            ...
                            <span style="color: rgb(137, 63, 242)"
                              >Aug/2022</span
                            >
                          </span>
                          <v-card
                          ...
                          >
                            <v-row v-if="datajp.result">
                              <v-col>{{
                                datajp.result.green_cover_area.toFixed(2) +
                                " sqkm"
                              }}</v-col>
                              <v-col>
                                <span
                                ...
                                Non Green Area:
                                {{
                                  this.datajp.result.non_green_area.toFixed(2) +
                                  " sqkm"
                                }}
                              </v-col>
                              <v-col>
                                ...
                                Water Area:
                                {{
                                  this.datajp.result.water_area.toFixed(2) +
                                  " sqkm"
                                }}
                              </v-col>
                            </v-row>
                        ...
                        <v-col sm="5" md="6">
                          ...
                          >
                            <v-row v-if="datajp.compare_result">
                              <v-col>{{
                                datajp.compare_result.green_cover_area.toFixed(
                                  2
                                ) + " sqkm"
                              }}</v-col>
                              <v-col>
                                ...
                                Non Green Area:
                                {{
                                  this.datajp.compare_result.non_green_area.toFixed(
                                    2
                                  ) + " sqkm"
                                }}
                              </v-col>
                              <v-col>
                                ...
                                Water Area:
                                {{
                                  this.datajp.compare_result.water_area.toFixed(
                                    2
                                  ) + " sqkm"
                                }}
                              </v-col>
                      ...
                      <v-row>
                        <v-col cols="12" class="pa-5">
                          ...
                          >
                            <v-row
                              v-if="datajp.result && datajp.compare_result"
                            >
                              <v-col>{{
                                Math.abs(
                                  datajp.result.area_percent_change.toFixed(2)
                                ) + " %"
                              }}</v-col>
                              <v-col>
                                {{
                                  (
                                    datajp.result.green_cover_area -
                                    datajp.compare_result.green_cover_area
                                  ).toFixed(0) + "sqkm"
                                }}
                              </v-col>
                            </v-row>
                    ...
                    >
                      ...
                      <v-row>
                        <v-col sm="5" md="6">
                          ...
                          >
                            <v-row
                              v-for="(items, i) in datajp.plant_health"
                              :key="i"
                            >
                        ...
                        <v-col sm="5" md="6">
                          ...
                          >
                            <v-row
                              v-for="(items, i) in datajp.compare_plant_health"
                              :key="i"
                            >
                              <v-col>{{ items.label }}</v-col>
                              <v-col>{{ items.color }}</v-col>
                        ...
                        <v-col cols="12" class="pa-5">
                          ...
                          >
                            ...
                            >
                              ...
                              <v-col>{{ items.color }}</v-col>
                              <v-col>{{
                                items.change_percent.toFixed(2)
                              }}</v-col>
                            </v-row>
                          </v-card>
                        </v-col>
                    ...
                    >
                      ...
                      <v-row>
                        <v-col sm="5" md="6">
                          ...
                          >
                            <v-row
                              v-for="(items, i) in datajp.green_density"
                              :key="i"
                            >
                              <v-col>{{ items.label }}</v-col>
                              <v-col>{{ items.color }}</v-col>
                        ...
                        <v-col sm="5" md="6">
                          ...
                          >
                            <v-row
                              v-for="(items, i) in datajp.compare_green_density"
                              :key="i"
                            >
                              <v-col>{{ items.label }}</v-col>
                              <v-col>{{ items.color }}</v-col>
            ...
            <div
              ...
              style="height: calc(100% - 5px); width: 50%"
            >
              <v-card> 
                <v-row></v-row>
                <v-row>
                  <Dashboard :data="datajp"/>
                </v-row>
              </v-card>
            </div>
          </div>
...
export default {
  ...
  async created() {
    ...
    console.log('get api', DataJaipur.data.data);
    this.datajp = DataJaipur.data.data;
    console.log('get api', this.datajs);
